...
class ControladorMovimentacao:
    ...
    def adicionar_movimentacao(self):
        ...
        if categoria is not None:
            ...
            self.__tela_movimentacao.mostrar_mensagem("Categoria não encontrada, por favor, cadastre-as no menu 'Cadastrar categorias orçamentárias'.")
    ...
    def excluir_movimentacao(self):
        ...
        if m is not None:
            movimentacao_orcamento = self.__controlador_geral.controlador_orcamento.excluir_movimentacoes(m)
            if movimentacao_orcamento is not None:
    ...
    def obter_movimentacoes(self, periodo, tipo): #Para uso do controle orçamento
